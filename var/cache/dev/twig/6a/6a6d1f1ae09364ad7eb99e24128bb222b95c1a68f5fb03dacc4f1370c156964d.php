...
class __TwigTemplate_2af1e5b21df0e01b45710a0bf15f59e4b5f742486093e6103c73c5ee77a62d7f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        <table>
            ...
            $context['_seq'] = twig_ensure_traversable(twig_sort_filter($this->env, twig_get_array_keys_filter(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 214, $this->source); })()), "bundles", [], "any", false, false, false, 214))));
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "/home/sanadi/app/panier/vendor/symfony/web-profiler-bundle/Resources/views/Collector/config.html.twig");
    }
}
